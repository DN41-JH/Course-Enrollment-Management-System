"""
Django settings for coursemanagement_backend project.
...
ROOT_URLCONF = 'coursemanagement_backend.urls'
...
WSGI_APPLICATION = 'coursemanagement_backend.wsgi.application'
